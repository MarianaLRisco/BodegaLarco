...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style.css?868">
    <!-- icons -->
      ...
      <div class="login-box">
        <form class="login-form" action="index.php">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" type="text" name="usuario" placeholder="Ingrese su correo" autofocus>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <div class="form-check">
              ...
              <label class="mb-2"><a href="#"  class="text-forgot" data-toggle="flip">Olvidé mi contraseña</a></label>
            </div>
          </div>  
          <div class="mb-3 btn-container">
            <a class="btn btn-primary  btn-block" href="pag-backup.php"><i class="fa fa-sign-in fa-lg fa-fw"></i>Iniciar Sesión</a>
          </div>
        </form>
        <form class="forget-form" action="index.php">
          ...
          <div class="mb-3 mt-3">
            <p class="mb-0"><a href="#" class="text-forgot" data-toggle="flip"><ion-icon name="chevron-back-outline"></ion-icon>Volver al Login</a></p>
          </div>
        </form>
      </div>
    </section>
