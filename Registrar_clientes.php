<?php
    ...
    if(!empty($_POST)){
        $aler='';
        if(empty($_POST['nombre'])||empty($_POST['apellido'])||empty($_POST['telefono'])||empty($_POST['direccion'])||empty($_POST['dni'])
        ){
            ...
            if($result > 0){
                ...
                if($query_insert){
                    $aler = '<div class="alert alert-success" role="alert">Cliente registrado exitosamente.</div>';
                }else{
                    ...
                    <div class="card col-sm-6 p-3">
                        ...
                        <div class="mb-2">
                            <form action="" method='post'>
                                ...
                                <input type="tel" required pattern="[0-9]{9}" oninvalid="this.setCustomValidity('El numero de telefono es de 9 numeros')" class="form-control" name="telefono" id="telefono" placeholder="ej. 965754024">
                                </div>
                                <div class="mb-2"> 
