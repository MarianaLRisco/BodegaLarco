<div class="col-auto sidebar col-sm-3 col-xl-2 px-sm-2 px-0 bg-dark flex-column min-vh-100" data-bs-toggle="sidebar" id="sidebar">
            <div href="/" class="d-flex align-items-center ml-2 link-dark text-decoration-none border-bottom mt-4">
                <img src="imagenes/sinfoto.png" alt="" width="51" height="52" class="rounded-circle me-2 mb-4">
                <p class='text-light text-center order-2 mb-4'><?php echo $name ?><br><?php echo $rol ?></p>
            </div>
            <ul class="nav nav-pills flex-column mb-sm-auto ml-2 mt-3 align-items-center align-items-sm-start" id="menu">
                <li class="nav-item">
