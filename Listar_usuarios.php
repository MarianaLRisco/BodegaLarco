                ...
                <section>
                    ...
                    <div class="container-lg ">
                        ...
                        <table class="table table-success table-striped" id="lista_usuarios">
                            ...
                            <tbody>
                            <?php
                                    $query = mysqli_query($conection, "SELECT u.idusuario,u.DNI, u.apellido, u.nombre, u.correo, u.usuario,u.clave, r.rol FROM usuario u inner join rol r WHERE r.idrol=u.rol order by u.idusuario;");
                                ...
                                <tr>
                                    ...
                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#eliminar_usuario">Eliminar</button>
                                    </td>
                                </tr>
                                <?php
