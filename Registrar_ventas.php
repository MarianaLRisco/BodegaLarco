                        ...
                        <div class="mb-2 row border rounded">
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        <td id="idproducto">--</td>
                                        <td><input type="text" name="nombre_p" id="nombre_p"></td>
                                        <td id="existencias">--</td>
                                        <td><input class="form-control-sm" type="text" name="cantidad" id="cantidad" value="0" min="1"></td>
