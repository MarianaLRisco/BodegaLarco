...
class Cliente{
    ...
    //Funciones del crud
    function ActualizarCliente($id,$dni,$nombre,$apellido,$direccion,$telefono){
        $sentencia = "UPDATE cliente SET DNI='$dni',nombre='$nombre',Apellido='$apellido',direccion='$direccion',telefono='$telefono' WHERE idusuario='$id';";
