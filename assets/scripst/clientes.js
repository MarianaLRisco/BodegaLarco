...
function getData() {
  tabla = $("#lista_clientes").DataTable({
    oLanguage: {
...
function ObtenerClienteID(usuario_id){
  parametros = {
    "cliente_id":usuario_id
  }
  $.ajax({
    data:parametros,
    url:"controler/Proveedorescontrol.php?op=obtenercliente",
    type:'POST',
    beforeSend:function(){},
...
function ActualizarClientes(){
  ...
  $.ajax({
    data:parametros,
    url:"controler/Clientescontrol.php?op=EditarCliente",
    type:'POST',
    beforeSend:function(){},
    success:function(response){
      console.log(response);
