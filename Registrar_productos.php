    ...
    if(!empty($_POST)){
        ...
        if(empty($_POST['proveedor'])||empty($_POST['contacto'])||empty($_POST['telefono'])||empty($_POST['direccion'])||empty($_POST['dni'])
            ...
            if($result > 0){
                ...
                $query_insert = mysqli_query($conection,"INSERT INTO proveedor(proveedor,nombre,DNI,telefono,direccion)
                VALUES ('$proveedor','$nombre','$dni','$telefono','$direccion')");
                if($query_insert){
                    ...
                    <div class="card col-sm-6 p-3">
                        ...
                        <div class="mb-2">
                            <form action="" method='post'>
                                ...
                                <input type="text" class="form-control" name="nombre" id="nombre" placeholder="ej. Coca-Cola">
                                </div>
                                <div class="mb-2"> 
